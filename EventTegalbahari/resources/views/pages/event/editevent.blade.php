    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="m-t-40" action="{{route('event.update',$event->id)}}" method="post">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="mdate" name="tanggal_pelaksanaan" type="text" class="form-control" placeholder="input tanggal rapat" required="" value="{{$event->tanggal_pelaksanaan}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group clockpicker">
                                    <input type="text" class="form-control" name="jam_pelaksanaan" value="{{$event->jam}}"> <span class="input-group-addon"> <span class="fa fa-clock-o"></span> </span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="tempat_pelaksanaan" class="form-control" required=""
                                   data-validation-required-message="This field is required" value="{{$event->tempat}}">
                            <div class="help-block"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="link_registrasi" class="form-control" required=""
                                   data-validation-required-message="This field is required" value="{{$event->link_registrasi}}">
                            <div class="help-block"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="contact_person" class="form-control" required=""
                                   data-validation-required-message="This field is required" value="{{$event->contact_person}}">
                            <div class="help-block"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea class="form-control" name="deskripsi" rows="5">{{$event->deskripsi}}</textarea>
                            <div class="help-block"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                         <textarea class="form-control" name="persyaratan" rows="5">{{$event->persyaratan}}</textarea>
                            <div class="help-block"></div>
                        </div>
                    </div>
