    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="nav-small-cap">PORTAL USERS</li>
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Event</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{route('event')}}">Daftar Eventmu</a></li>
                            <li><a href="{{route('event.create')}}">Publikasi Eventmu</a></li>
